...
import com.example.inventory.utils.CustomCustomerDetailsService;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (requestURI.startsWith("/api/users/register") && (requestTokenHeader == null || !requestTokenHeader.startsWith("Bearer "))) {
            chain.doFilter(request, response); // Skip JWT processing for register endpoint if no token
            return;
        }
